...
## This practice was done in a different way without using the Map() object, as well as doing the Dispatch directly at the file instead of doing all dispatchs as functions in the Context.jsx and then exporting the functions
